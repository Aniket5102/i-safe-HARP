...
export default function HarpIncidentDetailsPage() {
  ...
  const handleExportPdf = () => {
    ...
    doc.text('HARP Incident Report', pageWidth / 2, y, { align: 'center' });
    y += 8;
    doc.setFontSize(12);
    doc.setFont('helvetica', 'normal');
    doc.text(`Incident ID: ${incident.harpId}`, pageWidth / 2, y, { align: 'center' });
    y += 10;
    ...
    doc.save(`HARP-Incident-${incident.harpId}.pdf`);
  };
