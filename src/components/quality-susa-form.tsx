...
const formSchema = z.object({
  bbqReferenceNumber: z.string().optional(),
...
function QualitySusaFormContent() {
  ...
  const [foundIncident, setFoundIncident] = React.useState<IncidentDoc | null>(null);
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
        ...
        {activeTab !== 'new' && foundIncident && (
            ...
            <FormItem>
              <FormLabel>SUSA ID #</FormLabel>
              <FormControl>
                <Input disabled value={foundIncident.susaId} />
              </FormControl>
            </FormItem>
            <FormItem>
              <FormLabel>BBQ Reference Number</FormLabel>
              <FormControl>
                <Input disabled value={foundIncident.bbqReferenceNumber} />
              </FormControl>
            </FormItem>
            </>
        )}
      ...
      <CardHeader>
        ...
        >
          ...
          <TabsContent value="new" className="text-center">
            ...
            <CardDescription>
              Fill out the form to record a new Quality SUSA incident.
            </CardDescription>
          </TabsContent>
          <TabsContent value="modify" className="text-center">
            <CardTitle className="font-headline text-2xl">
              Modify Quality SUSA Incident
            </CardTitle>
            <CardDescription>
            ...
            {activeTab === "delete" && foundIncident && (
              <div className="text-center text-muted-foreground py-10 max-w-md mx-auto">
                <p>
                  ...
                  <span className="font-semibold">{foundIncident.susaId}</span>.
